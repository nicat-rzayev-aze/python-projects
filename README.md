...
3. `images/` - screenshots of visualizations
...
## How to Run
Run the scripts `tesla_stock.py` and `gamestop_stock.py` in Python to reproduce analysis and visualizations. Make sure you have installed the necessary libraries.
